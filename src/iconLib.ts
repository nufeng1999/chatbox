...
export const openai='<svg fill="none" xmlns="http://www.w3.org/2000/svg"\
    viewBox="0 0 320 320" class="a-icon--logo-text flex h-32" \
    style="overflow:auto;width:32px;height:32px;data-new="">\
    <g fill="currentColor" >\
...
export const chat='<svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>';
export const waiting= '\
<svg style="overflow:auto;opacity: 1.0;margin: auto;\
...
export default {chat,waiting,openai}